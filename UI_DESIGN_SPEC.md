...
> **版本**：v2.15 当前落地参考版
> **更新日期**：2026-07-10
> **说明**：本文保留 v2.2 基线问题分析，并汇总 v2.5–v2.15 已落地的 rail、主题和 Options 视觉决策；标注“需补充”的条目仍属于后续 backlog。
...
*本规范基于 Smart TOC & Scroll v2.2 基线问题分析形成，并已按 v2.15 当前落地状态整理，日期：2026-08-27。*
